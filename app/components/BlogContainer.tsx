...
const BlogContainer = ({className="",blogImageUrl,category,slug,createdAt,title,description,_id}:BlogContainerProps) => {
    return (
                    ...
                    <div className='flex justify-between items-center flex-wrap gap-4'>
                        <div className='flex gap-2'>
                            ...
                            <div className='flex flex-col'>
                                <span className='font-semibold italic'>Fitbit Incorporation</span>
                                <span>
